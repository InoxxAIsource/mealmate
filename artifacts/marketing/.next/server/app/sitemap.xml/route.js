"use strict";(()=>{var e={};e.id=717,e.ids=[717],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},1955:(e,a,i)=>{i.r(a),i.d(a,{originalPathname:()=>C,patchFetch:()=>P,requestAsyncStorage:()=>v,routeModule:()=>k,serverHooks:()=>S,staticGenerationAsyncStorage:()=>I});var t={};i.r(t),i.d(t,{default:()=>p});var n={};i.r(n),i.d(n,{GET:()=>w});var o=i(578),r=i(990),s=i(4488),l=i(2443);let d=[{id:"pcos",label:"PCOS",keywords:["hormone-friendly","low-GI","anti-inflammatory","insulin-friendly"],emoji:"\uD83C\uDF38",accent:"fb7185",description:"Hormone-balancing meals designed to manage PCOS symptoms through low-GI, anti-inflammatory Indian foods."},{id:"diabetes",label:"Diabetic",keywords:["low-GI","blood-sugar-friendly","millet-based","diabetic-safe"],emoji:"\uD83E\uDE7A",accent:"3b82f6",description:"Blood-sugar-friendly meal plans using millets, legumes, and low-GI Indian staples."},{id:"thyroid",label:"Thyroid",keywords:["thyroid-friendly","selenium-rich","iodine-rich","goitrogen-free"],emoji:"\uD83E\uDD8B",accent:"8b5cf6",description:"Thyroid-supportive nutrition with selenium-rich and iodine-rich Indian foods."},{id:"pregnancy",label:"Pregnancy",keywords:["folate-rich","iron-rich","trimester-safe","pregnancy-safe"],emoji:"\uD83E\uDD31",accent:"ec4899",description:"Safe, nutrient-dense meal plans for each trimester of pregnancy."},{id:"kids",label:"Kids",keywords:["child-friendly","nutrient-dense","school-tiffin","fussy-eater-friendly"],emoji:"\uD83D\uDC76",accent:"f59e0b",description:"Delicious, nutrient-packed meals and tiffin ideas growing children will love."},{id:"cholesterol",label:"Low Cholesterol",keywords:["heart-healthy","low-saturated-fat","high-fibre","cholesterol-lowering"],emoji:"❤️",accent:"ef4444",description:"Heart-healthy Indian meal plans to naturally lower LDL cholesterol."},{id:"weight-loss",label:"Weight Loss",keywords:["low-calorie","high-fibre","portion-controlled","metabolism-boosting"],emoji:"⚖️",accent:"10b981",description:"Calorie-controlled, filling Indian meals for sustainable weight management."},{id:"highprotein",label:"High Protein",keywords:["protein-rich","muscle-building","high-protein","post-workout"],emoji:"\uD83D\uDCAA",accent:"f97316",description:"Protein-packed Indian meal plans for muscle building and recovery."}],h=[{id:"north-indian",label:"North Indian"},{id:"south-indian",label:"South Indian"},{id:"east-indian",label:"East Indian"},{id:"west-indian",label:"West Indian"},{id:"bengali",label:"Bengali"},{id:"punjabi",label:"Punjabi"},{id:"gujarati",label:"Gujarati"},{id:"tamil",label:"Tamil"},{id:"kerala",label:"Kerala"},{id:"maharashtrian",label:"Maharashtrian"},{id:"andhra",label:"Andhra"},{id:"rajasthani",label:"Rajasthani"},{id:"mediterranean",label:"Mediterranean"},{id:"middle-eastern",label:"Middle Eastern"},{id:"nigerian",label:"Nigerian"},{id:"filipino",label:"Filipino"},{id:"mexican",label:"Mexican"}],c=[{id:"weekly-meal-plan",label:"Weekly Meal Plan"},{id:"7-day-meal-plan",label:"7-Day Meal Plan"},{id:"meal-plan",label:"Meal Plan"},{id:"diet-plan",label:"Diet Plan"},{id:"breakfast-ideas",label:"Breakfast Ideas"},{id:"lunch-ideas",label:"Lunch Ideas"},{id:"dinner-ideas",label:"Dinner Ideas"},{id:"snack-ideas",label:"Snack Ideas"}],g=[{slug:"pcos-diet-plan-india",title:"The Complete PCOS Diet Plan for Indian Women",metaTitle:"PCOS Diet Plan India: Complete Guide for Indian Women | MealCoreAI",metaDescription:"Discover the complete PCOS diet plan for Indian women. Low-GI foods, anti-inflammatory meals, and hormone-balancing recipes tailored to Indian cuisine.",category:"pcos",tags:["pcos","hormone-balance","indian-diet","low-gi"],excerpt:"Managing PCOS through diet is one of the most effective approaches. This complete guide covers what to eat, what to avoid, and sample Indian meal plans.",author:"Dr. Priya Sharma, Nutritionist",publishDate:"2025-11-15",readTimeMin:8,featuredImage:"/images/pcos-diet.jpg",relatedSlugs:["millet-benefits-pcos","pcos-breakfast-ideas-indian","pcos-insulin-resistance-diet"],internalLinks:[{anchor:"PCOS meal plan",url:"/pcos-meal-plan"},{anchor:"millet benefits for PCOS",url:"/blog/millet-benefits-pcos"},{anchor:"PCOS breakfast ideas",url:"/blog/pcos-breakfast-ideas-indian"},{anchor:"personalised meal planning",url:"https://mealcoreai.com/app/sign-up"}],content:`
...
<p>Every woman's PCOS is different. Some have predominant insulin resistance, others have androgen excess or thyroid involvement. MealCoreAI analyses your specific health profile, regional food preferences, cooking style, and taste preferences to build a PCOS meal plan that feels like home, not a medical prescription. Get your personalised <a href="/pcos-meal-plan">PCOS meal plan</a> today and see the difference in 30 days.</p>
    `.trim()},{slug:"diabetic-indian-breakfast-ideas",title:"25 Diabetic-Friendly Indian Breakfast Ideas",metaTitle:"25 Diabetic-Friendly Indian Breakfast Ideas | MealCoreAI",metaDescription:"Discover 25 delicious low-GI Indian breakfast ideas for diabetics. From ragi dosa to oats upma, blood-sugar-friendly mornings made easy.",category:"diabetes",tags:["diabetes","breakfast","low-gi","blood-sugar"],excerpt:"Starting the day with the right breakfast is crucial for blood sugar management. Here are 25 diabetic-friendly Indian breakfast ideas that are tasty and nutritious.",author:"Nutritionist Anitha Reddy",publishDate:"2025-11-20",readTimeMin:7,featuredImage:"/images/diabetic-breakfast.jpg",relatedSlugs:["low-gi-indian-foods-list","ragi-benefits-diabetes","gestational-diabetes-meal-plan"],internalLinks:[{anchor:"diabetes meal plan",url:"/diabetes-meal-plan"},{anchor:"low GI Indian foods",url:"/blog/low-gi-indian-foods-list"},{anchor:"ragi for diabetes",url:"/blog/ragi-benefits-diabetes"},{anchor:"personalised diabetes plan",url:"https://mealcoreai.com/app/sign-up"}],content:`
...
<p>MealCoreAI builds a custom <a href="/diabetes-meal-plan">diabetes meal plan</a> that accounts for your HbA1c levels, food preferences, and regional cuisine. Instead of searching for the "right" breakfast every morning, your plan gives you weekly variety that keeps blood sugar stable. <a href="https://mealcoreai.com/app/sign-up">Start free today</a>.</p>
    `.trim()},{slug:"thyroid-foods-avoid-india",title:"Thyroid Diet: Foods to Avoid and Eat (Complete Indian Guide)",metaTitle:"Thyroid Diet Foods to Avoid and Eat: Indian Guide | MealCoreAI",metaDescription:"Complete Indian guide on thyroid diet, which foods worsen hypothyroidism, which boost thyroid function, and a 7-day thyroid-friendly Indian meal plan.",category:"thyroid",tags:["thyroid","hypothyroidism","goitrogens","selenium"],excerpt:"Thyroid health is profoundly affected by diet. This guide covers goitrogenic foods to avoid, selenium-rich foods to eat, and a practical Indian thyroid diet plan.",author:"Nutritionist Kavya Iyer",publishDate:"2025-11-25",readTimeMin:9,featuredImage:"/images/thyroid-diet.jpg",relatedSlugs:["thyroid-weight-gain-diet","low-gi-indian-foods-list","meal-planning-beginners-india"],internalLinks:[{anchor:"thyroid diet plan",url:"/thyroid-diet-plan"},{anchor:"thyroid and weight gain",url:"/blog/thyroid-weight-gain-diet"},{anchor:"meal planning guide",url:"/blog/meal-planning-beginners-india"},{anchor:"personalised thyroid plan",url:"https://mealcoreai.com/app/sign-up"}],content:`
...
<p><strong>Day 1:</strong> B. Ragi dosa with coconut chutney and sambar. L. Brown rice, fish curry, drumstick sambar. D. Moong dal, bajra roti, saut\xe9ed spinach.<br>
...
<p>Managing thyroid through diet requires precision, getting enough iodine and selenium while moderating goitrogens. MealCoreAI creates a custom <a href="/thyroid-diet-plan">thyroid diet plan</a> that balances all these requirements while keeping meals delicious and culturally appropriate. <a href="https://mealcoreai.com/app/sign-up">Start your free plan today</a>.</p>
    `.trim()},{slug:"pregnancy-nutrition-first-trimester",title:"First Trimester Nutrition for Indian Moms: Complete Guide",metaTitle:"First Trimester Pregnancy Nutrition for Indian Moms | MealCoreAI",metaDescription:"Essential nutrition guide for the first trimester of pregnancy. Folate, iron, and nausea-friendly foods for Indian mothers. Includes a week-long meal plan.",category:"pregnancy",tags:["pregnancy","first-trimester","folate","prenatal-nutrition"],excerpt:"The first trimester sets the foundation for your baby's development. This guide covers essential nutrients, nausea management tips, and a practical Indian meal plan.",author:"Dr. Meena Patel, OB-GYN Nutritionist",publishDate:"2025-12-01",readTimeMin:8,featuredImage:"/images/pregnancy-nutrition.jpg",relatedSlugs:["iron-rich-foods-pregnancy-india","pregnancy-foods-to-avoid","gestational-diabetes-meal-plan"],internalLinks:[{anchor:"pregnancy meal plan",url:"/pregnancy-meal-plan"},{anchor:"iron-rich foods for pregnancy",url:"/blog/iron-rich-foods-pregnancy-india"},{anchor:"foods to avoid during pregnancy",url:"/blog/pregnancy-foods-to-avoid"},{anchor:"personalised pregnancy plan",url:"https://mealcoreai.com/app/sign-up"}],content:`
...
<p>Every pregnancy is unique, your weight, health conditions, and food preferences determine what's optimal for you. MealCoreAI builds a trimester-by-trimester <a href="/pregnancy-meal-plan">pregnancy meal plan</a> tailored to your regional cuisine and nutritional needs. <a href="https://mealcoreai.com/app/sign-up">Start your free plan today</a>.</p>
    `.trim()},{slug:"kids-healthy-tiffin-ideas",title:"30 Healthy Tiffin Box Ideas for Indian Kids",metaTitle:"30 Healthy Tiffin Box Ideas for Indian Kids | MealCoreAI",metaDescription:"30 nutritious and delicious tiffin box ideas for Indian school kids. Easy to pack, loved by children, and parent-approved for health and nutrition.",category:"kids",tags:["kids","tiffin","school-lunch","child-nutrition"],excerpt:"Packing a healthy tiffin that kids will actually eat is a daily challenge. Here are 30 proven tiffin ideas that are nutritious, easy to prepare, and loved by children.",author:"Child Nutritionist Suman Verma",publishDate:"2025-12-05",readTimeMin:7,featuredImage:"/images/kids-tiffin.jpg",relatedSlugs:["kids-calcium-foods-india","kids-fussy-eater-meal-ideas","meal-planning-beginners-india"],internalLinks:[{anchor:"kids meal plan",url:"/kids-meal-plan"},{anchor:"calcium foods for kids",url:"/blog/kids-calcium-foods-india"},{anchor:"fussy eater ideas",url:"/blog/kids-fussy-eater-meal-ideas"},{anchor:"personalised kids plan",url:"https://mealcoreai.com/app/sign-up"}],content:`
...
<p>MealCoreAI creates a personalised <a href="/kids-meal-plan">kids meal plan</a> that covers breakfast, tiffin, and dinner, tailored to your child's age, activity level, and food preferences. <a href="https://mealcoreai.com/app/sign-up">Get your free plan today</a>.</p>
    `.trim()},{slug:"millet-benefits-pcos",title:"Why Millets Are a Game-Changer for PCOS Management",metaTitle:"Millet Benefits for PCOS: Why Millets Help Manage PCOS | MealCoreAI",metaDescription:"Discover why millets like ragi, bajra, and foxtail millet are among the best foods for PCOS management. Science-backed benefits and practical Indian meal ideas.",category:"pcos",tags:["pcos","millets","ragi","bajra","low-gi"],excerpt:"Millets are emerging as the most powerful dietary tool for PCOS management. Here's why ragi, bajra, and foxtail millet should replace refined grains in your PCOS diet.",author:"Dr. Priya Sharma, Nutritionist",publishDate:"2025-12-08",readTimeMin:6,featuredImage:"/images/millets-pcos.jpg",relatedSlugs:["pcos-diet-plan-india","pcos-breakfast-ideas-indian","low-gi-indian-foods-list"],internalLinks:[{anchor:"PCOS diet plan",url:"/blog/pcos-diet-plan-india"},{anchor:"PCOS meal plan",url:"/pcos-meal-plan"},{anchor:"low GI Indian foods",url:"/blog/low-gi-indian-foods-list"},{anchor:"personalised PCOS plan",url:"https://mealcoreai.com/app/sign-up"}],content:`
...
<p>MealCoreAI builds daily meal plans centred around millets and other PCOS-friendly foods, tailored to your regional cuisine and taste preferences. Your personalised <a href="/pcos-meal-plan">PCOS meal plan</a> is waiting. <a href="https://mealcoreai.com/app/sign-up">Start free today</a>.</p>
    `.trim()},{slug:"ragi-benefits-diabetes",title:"Ragi and Diabetes: How This Grain Stabilises Blood Sugar",metaTitle:"Ragi for Diabetes: Benefits, Recipes & Blood Sugar | MealCoreAI",metaDescription:"Discover how ragi (finger millet) helps diabetics stabilise blood sugar. GI data, nutritional profile, and easy ragi recipes for Indian diabetics.",category:"diabetes",tags:["diabetes","ragi","finger-millet","blood-sugar"],excerpt:"Ragi is one of India's most powerful foods for diabetes management. Here's the science behind its blood sugar benefits and how to include it daily.",author:"Nutritionist Anitha Reddy",publishDate:"2025-12-10",dateModified:"2026-05-02",readTimeMin:6,featuredImage:"/images/ragi-diabetes.jpg",keyTakeaways:["Ragi has a glycaemic index of 54 vs white rice at 72 — every ragi meal means measurably lower post-meal blood sugar.","Ragi's soluble fibre slows glucose absorption independently of its low GI, giving diabetics a double blood-sugar benefit.","100g of ragi contains 3.6g of fibre and more calcium than milk — the most nutrient-dense grain swap in Indian cooking.","Switching just one rice-based meal per day to a ragi preparation has a meaningful impact on daily blood sugar exposure.","Ragi works as dosa, idli, upma, roti, and porridge — no compromise on Indian food variety required."],relatedSlugs:["diabetic-indian-breakfast-ideas","low-gi-indian-foods-list","south-indian-diet-weight-loss"],internalLinks:[{anchor:"diabetes meal plan",url:"/diabetes-meal-plan"},{anchor:"diabetic breakfast ideas",url:"/blog/diabetic-indian-breakfast-ideas"},{anchor:"low GI Indian foods list",url:"/blog/low-gi-indian-foods-list"},{anchor:"personalised diabetes plan",url:"https://mealcoreai.com/app/sign-up"}],content:`
...
<p>MealCoreAI builds a custom <a href="/diabetes-meal-plan">diabetes meal plan</a> that incorporates ragi and other diabetes-friendly millets based on your specific regional preferences and taste profile. <a href="https://mealcoreai.com/app/sign-up">Start your free plan today</a>.</p>
    `.trim()},{slug:"south-indian-diet-weight-loss",title:"South Indian Diet Plan for Weight Loss: Complete Guide",metaTitle:"South Indian Diet Plan for Weight Loss | MealCoreAI",metaDescription:"A complete South Indian diet plan for weight loss. Which traditional foods to eat, which to limit, and a 7-day meal plan for sustainable weight management.",category:"general",tags:["weight-loss","south-indian","calorie-deficit","healthy-diet"],excerpt:"South Indian cuisine, when eaten mindfully, is one of the most weight-loss-friendly diets in the world. Here's how to harness its potential for sustainable fat loss.",author:"Nutritionist Kavya Iyer",publishDate:"2025-12-12",readTimeMin:7,featuredImage:"/images/south-indian-diet.jpg",relatedSlugs:["ragi-benefits-diabetes","low-gi-indian-foods-list","meal-planning-beginners-india"],internalLinks:[{anchor:"ragi benefits",url:"/blog/ragi-benefits-diabetes"},{anchor:"low GI Indian foods",url:"/blog/low-gi-indian-foods-list"},{anchor:"meal planning guide",url:"/blog/meal-planning-beginners-india"},{anchor:"personalised weight loss plan",url:"https://mealcoreai.com/app/sign-up"}],content:`
...
<p>MealCoreAI creates a customised South Indian meal plan for your weight loss goals, accounting for your caloric needs, food preferences, and lifestyle. <a href="https://mealcoreai.com/app/sign-up">Start your free plan today</a>.</p>
    `.trim()},{slug:"pcos-breakfast-ideas-indian",title:"20 PCOS-Friendly Indian Breakfast Ideas That Balance Hormones",metaTitle:"20 PCOS-Friendly Indian Breakfast Ideas | MealCoreAI",metaDescription:"20 hormone-balancing, low-GI Indian breakfast ideas for women with PCOS. Quick to prepare, nutritious, and designed to reduce insulin spikes.",category:"pcos",tags:["pcos","breakfast","hormone-balance","low-gi"],excerpt:"The right breakfast can significantly reduce PCOS symptoms by preventing morning insulin spikes. Here are 20 PCOS-friendly Indian breakfast ideas.",author:"Dr. Priya Sharma, Nutritionist",publishDate:"2025-12-15",readTimeMin:6,featuredImage:"/images/pcos-breakfast.jpg",relatedSlugs:["pcos-diet-plan-india","millet-benefits-pcos","pcos-insulin-resistance-diet"],internalLinks:[{anchor:"PCOS diet plan",url:"/blog/pcos-diet-plan-india"},{anchor:"PCOS meal plan",url:"/pcos-meal-plan"},{anchor:"millet benefits for PCOS",url:"/blog/millet-benefits-pcos"},{anchor:"PCOS insulin resistance",url:"/blog/pcos-insulin-resistance-diet"}],content:`
...
<p>MealCoreAI generates a new weekly breakfast schedule every week, tailored to your PCOS symptoms, preferred cooking time, and taste preferences. Get your personalised <a href="/pcos-meal-plan">PCOS meal plan</a> and wake up knowing exactly what to eat. <a href="https://mealcoreai.com/app/sign-up">Start free today</a>.</p>
    `.trim()},{slug:"gestational-diabetes-meal-plan",title:"Gestational Diabetes Meal Plan: Complete Indian Guide",metaTitle:"Gestational Diabetes Meal Plan India: Complete Guide | MealCoreAI",metaDescription:"Complete Indian meal plan for gestational diabetes. Blood-sugar-friendly meals for each trimester, safe Indian foods, and practical tips for managing GDM.",category:"diabetes",tags:["gestational-diabetes","pregnancy","blood-sugar","meal-plan"],excerpt:"Gestational diabetes requires careful nutritional management. This complete guide covers safe Indian foods, a 7-day meal plan, and blood sugar management strategies.",author:"Dr. Meena Patel, OB-GYN Nutritionist",publishDate:"2025-12-18",dateModified:"2026-05-02",readTimeMin:8,featuredImage:"/images/gestational-diabetes.jpg",keyTakeaways:["GDM affects 10–14% of Indian pregnancies and must be managed through diet before insulin is considered.","Low-GI grains (ragi, jowar, bajra) replace white rice and maida at most meals to blunt post-meal glucose spikes during pregnancy.","Protein at every meal — dal, curd, eggs, or paneer — slows glucose absorption and prevents the sharp peaks that drive GDM complications.","Fruit is safe in GDM but must be eaten as a standalone snack, never immediately after a carbohydrate-heavy meal.","Meal timing every 2–3 hours is as critical as food choice — skipping meals causes counter-regulatory blood sugar swings that worsen GDM."],relatedSlugs:["pregnancy-nutrition-first-trimester","diabetic-indian-breakfast-ideas","low-gi-indian-foods-list"],internalLinks:[{anchor:"pregnancy meal plan",url:"/pregnancy-meal-plan"},{anchor:"diabetes meal plan",url:"/diabetes-meal-plan"},{anchor:"diabetic breakfast ideas",url:"/blog/diabetic-indian-breakfast-ideas"},{anchor:"personalised GDM plan",url:"https://mealcoreai.com/app/sign-up"}],content:`
...
<p>MealCoreAI builds a trimester-specific gestational diabetes <a href="/pregnancy-meal-plan">pregnancy meal plan</a> that keeps blood sugar within target while ensuring complete nutrition for your baby. <a href="https://mealcoreai.com/app/sign-up">Start free today</a>.</p>
    `.trim()},{slug:"thyroid-weight-gain-diet",title:"Thyroid and Weight Gain: Fix It With the Right Diet",metaTitle:"How to Lose Weight with Hypothyroidism: Indian Diet | MealCoreAI",metaDescription:"Struggling with thyroid-related weight gain? Learn exactly which foods help, which hurt, and how to structure your Indian diet for thyroid-friendly weight management.",category:"thyroid",tags:["thyroid","weight-gain","hypothyroidism","metabolism"],excerpt:"Thyroid-related weight gain is notoriously resistant to standard diets. This guide explains the metabolic reasons why and provides a diet strategy that actually works.",author:"Nutritionist Kavya Iyer",publishDate:"2025-12-20",dateModified:"2026-05-02",readTimeMin:7,featuredImage:"/images/thyroid-weight.jpg",keyTakeaways:["Hypothyroid weight gain is driven by a 5–15% reduction in basal metabolic rate — not overeating.","Addressing selenium, iodine, and zinc deficiencies is the first dietary priority; these directly enable thyroid hormone conversion.","Anti-inflammatory eating measurably reduces thyroid antibody levels and can improve T4-to-active-T3 conversion over 3–6 months.","Millet-based meals (bajra, jowar) support calorie-controlled eating for thyroid patients without causing hunger or fatigue.","Avoiding cooked cruciferous vegetables is unnecessary — cooking destroys 95% of the goitrogenic compounds that concern thyroid patients."],relatedSlugs:["thyroid-foods-avoid-india","low-gi-indian-foods-list","south-indian-diet-weight-loss"],internalLinks:[{anchor:"thyroid diet guide",url:"/blog/thyroid-foods-avoid-india"},{anchor:"thyroid meal plan",url:"/thyroid-diet-plan"},{anchor:"South Indian diet for weight loss",url:"/blog/south-indian-diet-weight-loss"},{anchor:"personalised thyroid plan",url:"https://mealcoreai.com/app/sign-up"}],content:`
...
<p><strong>Day 1:</strong> B, 2 eggs + ragi roti. L. Brown rice (half cup) + fish curry + salad. D. Dal soup + saut\xe9ed vegetables. Snack, 2 Brazil nuts + green tea.<br>
...
<p>MealCoreAI creates a custom <a href="/thyroid-diet-plan">thyroid diet plan</a> that accounts for your metabolism, food preferences, and weight goals. Start seeing results within 4–6 weeks. <a href="https://mealcoreai.com/app/sign-up">Begin your free plan today</a>.</p>
    `.trim()},{slug:"iron-rich-foods-pregnancy-india",title:"30 Iron-Rich Indian Foods Every Pregnant Woman Needs",metaTitle:"30 Iron-Rich Indian Foods for Pregnancy | MealCoreAI",metaDescription:"Complete list of 30 iron-rich Indian foods for pregnancy. Haem and non-haem iron sources, absorption tips, and practical meal ideas for preventing anaemia.",category:"pregnancy",tags:["pregnancy","iron","anaemia","prenatal-nutrition"],excerpt:"Iron deficiency anaemia affects 50% of Indian pregnant women. Here are 30 iron-rich Indian foods and how to maximise their absorption.",author:"Dr. Meena Patel, OB-GYN Nutritionist",publishDate:"2025-12-22",readTimeMin:7,featuredImage:"/images/iron-pregnancy.jpg",relatedSlugs:["pregnancy-nutrition-first-trimester","pregnancy-foods-to-avoid","gestational-diabetes-meal-plan"],internalLinks:[{anchor:"pregnancy meal plan",url:"/pregnancy-meal-plan"},{anchor:"first trimester nutrition",url:"/blog/pregnancy-nutrition-first-trimester"},{anchor:"foods to avoid in pregnancy",url:"/blog/pregnancy-foods-to-avoid"},{anchor:"personalised pregnancy plan",url:"https://mealcoreai.com/app/sign-up"}],content:`
...
<p>MealCoreAI designs an iron-optimised <a href="/pregnancy-meal-plan">pregnancy meal plan</a> that ensures you meet your daily iron requirements through food, with strategic pairings for maximum absorption. <a href="https://mealcoreai.com/app/sign-up">Start free today</a>.</p>
    `.trim()},{slug:"kids-calcium-foods-india",title:"Top 20 Calcium-Rich Foods for Growing Indian Kids",metaTitle:"20 Calcium-Rich Indian Foods for Kids | MealCoreAI",metaDescription:"Calcium-rich Indian foods for children's bone development. From dairy to millets, 20 foods and practical recipes to ensure your child gets enough calcium daily.",category:"kids",tags:["kids","calcium","bone-health","child-nutrition"],excerpt:"Adequate calcium during childhood determines lifelong bone density. Here are 20 calcium-rich Indian foods and practical ways to include them in your child's daily diet.",author:"Child Nutritionist Suman Verma",publishDate:"2025-12-24",readTimeMin:6,featuredImage:"/images/kids-calcium.jpg",relatedSlugs:["kids-healthy-tiffin-ideas","kids-fussy-eater-meal-ideas","meal-planning-beginners-india"],internalLinks:[{anchor:"kids meal plan",url:"/kids-meal-plan"},{anchor:"healthy tiffin ideas",url:"/blog/kids-healthy-tiffin-ideas"},{anchor:"fussy eater solutions",url:"/blog/kids-fussy-eater-meal-ideas"},{anchor:"personalised kids plan",url:"https://mealcoreai.com/app/sign-up"}],content:`
...
<p>MealCoreAI creates a personalised <a href="/kids-meal-plan">kids meal plan</a> ensuring adequate calcium, iron, and all essential nutrients for growth. <a href="https://mealcoreai.com/app/sign-up">Start free today</a>.</p>
    `.trim()},{slug:"low-gi-indian-foods-list",title:"Low GI Indian Foods: Complete List for Diabetes and PCOS",metaTitle:"Low GI Indian Foods List for Diabetes and PCOS | MealCoreAI",metaDescription:"Complete list of low glycaemic index Indian foods. Know exactly which dal, roti, rice, and snacks are safe for diabetes and PCOS management.",category:"nutrition",tags:["low-gi","glycaemic-index","diabetes","pcos"],excerpt:"A comprehensive list of low GI Indian foods across all food categories, grains, dals, vegetables, fruits, snacks, with practical tips for building blood-sugar-friendly meals.",author:"Nutritionist Anitha Reddy",publishDate:"2025-12-26",readTimeMin:8,featuredImage:"/images/low-gi-foods.jpg",relatedSlugs:["diabetic-indian-breakfast-ideas","pcos-diet-plan-india","ragi-benefits-diabetes"],internalLinks:[{anchor:"diabetes meal plan",url:"/diabetes-meal-plan"},{anchor:"PCOS meal plan",url:"/pcos-meal-plan"},{anchor:"ragi for diabetes",url:"/blog/ragi-benefits-diabetes"},{anchor:"diabetic breakfast ideas",url:"/blog/diabetic-indian-breakfast-ideas"}],content:`
...
<p>MealCoreAI automatically builds meal plans using low-GI foods tailored to your condition, whether <a href="/diabetes-meal-plan">diabetes</a> or <a href="/pcos-meal-plan">PCOS</a>. Your personalised plan is just a click away. <a href="https://mealcoreai.com/app/sign-up">Start free today</a>.</p>
    `.trim()},{slug:"meal-planning-beginners-india",title:"Meal Planning for Beginners: How to Plan Healthy Indian Meals",metaTitle:"Indian Meal Planning for Beginners: Complete Guide | MealCoreAI",metaDescription:"Step-by-step guide to meal planning for Indian families. Save time, eat healthier, and reduce food waste with this complete beginner's guide to Indian meal planning.",category:"general",tags:["meal-planning","beginners","healthy-eating","indian-diet"],excerpt:"Meal planning doesn't have to be complicated. This beginner's guide walks you through planning healthy Indian meals for the week in under 30 minutes.",author:"Nutritionist Kavya Iyer",publishDate:"2025-12-28",readTimeMin:6,featuredImage:"/images/meal-planning.jpg",relatedSlugs:["low-gi-indian-foods-list","pcos-diet-plan-india","diabetic-indian-breakfast-ideas"],internalLinks:[{anchor:"low GI foods",url:"/blog/low-gi-indian-foods-list"},{anchor:"PCOS meal plan",url:"/pcos-meal-plan"},{anchor:"diabetes meal plan",url:"/diabetes-meal-plan"},{anchor:"try MealCoreAI free",url:"https://mealcoreai.com/app/sign-up"}],content:`
...
<p>Skip the 30 minutes of Sunday planning. MealCoreAI generates your personalised weekly Indian meal plan in seconds, tailored to your health goals. <a href="https://mealcoreai.com/app/sign-up">Start free today</a>.</p>
    `.trim()},{slug:"pcos-insulin-resistance-diet",title:"Insulin Resistance and PCOS: The Diet That Actually Works",metaTitle:"PCOS Insulin Resistance Diet: What to Eat and Avoid | MealCoreAI",metaDescription:"Insulin resistance is at the core of most PCOS cases. This guide explains the science and the specific Indian diet changes that improve insulin sensitivity for PCOS.",category:"pcos",tags:["pcos","insulin-resistance","low-gi","hormones"],excerpt:"80% of PCOS cases involve insulin resistance. Understanding and addressing it through diet is the most effective long-term strategy for managing PCOS symptoms.",author:"Dr. Priya Sharma, Nutritionist",publishDate:"2026-01-02",dateModified:"2026-05-02",readTimeMin:7,featuredImage:"/images/pcos-insulin.jpg",keyTakeaways:["80% of PCOS cases involve insulin resistance — treating it through diet is the most effective long-term strategy for symptom control.","Low-GI foods (ragi, jowar, bajra, moong dal) blunt insulin spikes that worsen the hormonal cascade driving PCOS.","Adding protein to every meal reduces post-meal insulin demand by 20–40%, directly lowering the hormonal load on the ovaries.","Inositol-rich foods (buckwheat, beans, citrus) measurably improve insulin receptor sensitivity over 3 months of consistent intake.","Removing refined carbohydrates (maida, white rice, sugar) shows measurable changes in androgen levels within 8–12 weeks."],relatedSlugs:["pcos-diet-plan-india","millet-benefits-pcos","pcos-breakfast-ideas-indian"],internalLinks:[{anchor:"PCOS diet plan",url:"/blog/pcos-diet-plan-india"},{anchor:"PCOS meal plan",url:"/pcos-meal-plan"},{anchor:"millet benefits for PCOS",url:"/blog/millet-benefits-pcos"},{anchor:"personalised PCOS plan",url:"https://mealcoreai.com/app/sign-up"}],content:`
...
Dinner (7:30pm), 1 bajra roti + moong dal + saut\xe9ed bhindi.</p>
...
<p>MealCoreAI creates a personalised <a href="/pcos-meal-plan">PCOS meal plan</a> specifically calibrated for insulin resistance, every meal designed to flatten your blood sugar curve and reduce androgen stimulation. <a href="https://mealcoreai.com/app/sign-up">Start free today</a>.</p>
    `.trim()},{slug:"pregnancy-foods-to-avoid",title:"Foods to Avoid During Pregnancy: Complete Indian Guide",metaTitle:"Foods to Avoid During Pregnancy: Indian Guide | MealCoreAI",metaDescription:"Complete guide to foods Indian pregnant women should avoid. From raw papaya to unpasteurised dairy, what's unsafe and why, with safer alternatives.",category:"pregnancy",tags:["pregnancy","food-safety","prenatal","what-to-avoid"],excerpt:"Knowing what NOT to eat during pregnancy is as important as knowing what to eat. This guide covers all the Indian foods to avoid and their safer alternatives.",author:"Dr. Meena Patel, OB-GYN Nutritionist",publishDate:"2026-01-05",readTimeMin:6,featuredImage:"/images/pregnancy-avoid.jpg",relatedSlugs:["pregnancy-nutrition-first-trimester","iron-rich-foods-pregnancy-india","gestational-diabetes-meal-plan"],internalLinks:[{anchor:"pregnancy meal plan",url:"/pregnancy-meal-plan"},{anchor:"first trimester nutrition",url:"/blog/pregnancy-nutrition-first-trimester"},{anchor:"iron-rich pregnancy foods",url:"/blog/iron-rich-foods-pregnancy-india"},{anchor:"personalised pregnancy plan",url:"https://mealcoreai.com/app/sign-up"}],content:`
...
<ul>
  <li><strong>Raw sprouts:</strong> Bacteria thrive in the warm, humid conditions needed for sprouting. Even homegrown sprouts are risky. If you love sprouts, cook them thoroughly (saut\xe9 or add to boiling dal).</li>
...
<p>MealCoreAI builds a trimester-specific <a href="/pregnancy-meal-plan">pregnancy meal plan</a> that automatically excludes unsafe foods while maximising nutrition for you and your baby. <a href="https://mealcoreai.com/app/sign-up">Start your free plan today</a>.</p>
    `.trim()},{slug:"cholesterol-lowering-indian-foods",title:"20 Indian Foods That Naturally Lower Cholesterol",metaTitle:"20 Indian Foods That Lower Cholesterol Naturally | MealCoreAI",metaDescription:"Discover 20 powerful Indian foods that naturally lower LDL cholesterol and improve heart health. Science-backed food choices from Indian cuisine for cholesterol management.",category:"cholesterol",tags:["cholesterol","heart-health","low-cholesterol","indian-diet"],excerpt:"Nature's most powerful cholesterol-lowering foods are hiding in Indian kitchens. Here are 20 everyday Indian foods proven to reduce LDL and improve heart health.",author:"Nutritionist Anitha Reddy",publishDate:"2026-01-08",readTimeMin:7,featuredImage:"/images/cholesterol-foods.jpg",relatedSlugs:["low-gi-indian-foods-list","south-indian-diet-weight-loss","meal-planning-beginners-india"],internalLinks:[{anchor:"cholesterol diet plan",url:"/cholesterol-diet-plan"},{anchor:"low GI Indian foods",url:"/blog/low-gi-indian-foods-list"},{anchor:"meal planning guide",url:"/blog/meal-planning-beginners-india"},{anchor:"personalised cholesterol plan",url:"https://mealcoreai.com/app/sign-up"}],content:`
...
<p>MealCoreAI creates a custom <a href="/cholesterol-diet-plan">cholesterol-lowering meal plan</a> that incorporates the most effective foods for your specific lipid profile and food preferences. <a href="https://mealcoreai.com/app/sign-up">Start free today</a>.</p>
    `.trim()},{slug:"kids-fussy-eater-meal-ideas",title:"Meal Ideas for Fussy Eaters: An Indian Parent's Complete Guide",metaTitle:"Fussy Eater Meal Ideas India: Complete Guide for Parents | MealCoreAI",metaDescription:"Practical meal ideas for fussy eater Indian kids. Why children become picky eaters, proven strategies to expand their palate, and 20 meals they'll actually eat.",category:"kids",tags:["kids","fussy-eater","picky-eater","child-nutrition"],excerpt:"Picky eating is one of parenthood's greatest frustrations. This guide explains why it happens and offers 20 nutritious meal ideas that fussy eaters actually accept.",author:"Child Nutritionist Suman Verma",publishDate:"2026-01-10",readTimeMin:7,featuredImage:"/images/fussy-eater.jpg",relatedSlugs:["kids-healthy-tiffin-ideas","kids-calcium-foods-india","meal-planning-beginners-india"],internalLinks:[{anchor:"kids meal plan",url:"/kids-meal-plan"},{anchor:"tiffin ideas for kids",url:"/blog/kids-healthy-tiffin-ideas"},{anchor:"calcium foods for kids",url:"/blog/kids-calcium-foods-india"},{anchor:"personalised kids plan",url:"https://mealcoreai.com/app/sign-up"}],content:`
...
<p>MealCoreAI creates a personalised <a href="/kids-meal-plan">kids meal plan</a> that includes alternatives for picky eaters while ensuring nutritional completeness. <a href="https://mealcoreai.com/app/sign-up">Start free today</a>.</p>
    `.trim()},{slug:"ai-meal-planning-personalised-nutrition",title:"How AI is Changing Personalised Nutrition Globally",metaTitle:"AI Meal Planning: Personalised Nutrition for Indians | MealCoreAI",metaDescription:"Discover how AI-powered meal planning is revolutionising personalised nutrition. From genetic-based meal plans to real-time glucose monitoring, the future of eating well.",category:"general",tags:["ai","personalised-nutrition","technology","meal-planning"],excerpt:"Artificial intelligence is making truly personalised nutrition accessible to everyone. Here's how AI meal planning works, its benefits, and why it's especially powerful for Indian diets.",author:"MealCoreAI Editorial Team",publishDate:"2026-01-12",dateModified:"2026-05-02",readTimeMin:7,featuredImage:"/images/ai-nutrition.jpg",keyTakeaways:["Generic diet charts give every person the same plan — AI personalises each meal to your specific condition, region, and food preferences.","AI meal planning processes glycaemic index, micronutrient targets, and cultural food preferences simultaneously — impossible for any static chart.","For Indian women, regional variation is essential: a Tamil diet plan and a Punjabi diet plan are completely different in practice.","AI plans adapt as your health markers and adherence patterns change — a printed chart is outdated from day two.","MealCoreAI generates a fully personalised weekly Indian meal plan in 90 seconds, free to start."],relatedSlugs:["meal-planning-beginners-india","pcos-diet-plan-india","low-gi-indian-foods-list"],internalLinks:[{anchor:"personalised meal planning",url:"https://mealcoreai.com/app/sign-up"},{anchor:"PCOS meal plan",url:"/pcos-meal-plan"},{anchor:"diabetes meal plan",url:"/diabetes-meal-plan"},{anchor:"how MealCoreAI works",url:"/how-it-works"}],content:`
...
<p>Experience what personalised AI nutrition feels like. <a href="/how-it-works">See how MealCoreAI works</a> and <a href="https://mealcoreai.com/app/sign-up">start your free personalised plan today</a>. No generic advice, just meals designed for your specific health condition, your regional cuisine, and your taste preferences.</p>
    `.trim()},{slug:"vrat-diet-plan-india",title:"Hindu Vrat Diet Plan: What to Eat and Avoid on Fasting Days (2025 Guide)",metaTitle:"Hindu Vrat Diet Plan India: Complete Fasting Guide | MealCoreAI",metaDescription:"Complete guide to Hindu vrat diet, what to eat (sabudana, kuttu, makhana, sama rice) and strictly avoid during Navratri, Ekadashi, Monday, and other fasting days. Includes 7-day sample plan.",category:"nutrition",tags:["vrat","fasting","navratri","ekadashi","sattvik","indian-diet"],excerpt:"A vrat (Hindu fast) diet replaces regular grains and non-vegetarian foods with sattvik, sattvic alternatives. Here is a complete guide with a 7-day plan, approved foods, and what to strictly avoid.",author:"Nutritionist Kavita Rao, RD",publishDate:"2025-04-10",dateModified:"2026-05-02",readTimeMin:7,featuredImage:"/images/vrat-diet.jpg",keyTakeaways:["A vrat diet eliminates regular grains, pulses, onion, and garlic — replacing them with sabudana, kuttu, sama chawal, rajgira, and makhana.","Navratri, Ekadashi, Mahashivratri, and Monday fasts each have distinct permitted food lists — the rules vary by fast type and regional tradition.","The most common vrat diet mistake is over-relying on fried sabudana and potato, which spikes blood sugar — balanced preparations use curd, peanuts, and makhana.","Sabudana provides roughly 350 calories per serving with a moderate glycaemic response, suitable for most metabolic conditions when portioned correctly.","A structured vrat meal plan can meet your protein and micronutrient targets while fully respecting the dietary rules of your specific fast."],relatedSlugs:["pcos-diet-plan-india","meal-planning-beginners-india","millet-benefits-pcos"],internalLinks:[{anchor:"personalised vrat meal plan",url:"https://mealcoreai.com/app/sign-up"},{anchor:"how MealCoreAI works",url:"/how-it-works"},{anchor:"Indian meal planning guide",url:"/meal-plans"}],content:`
...
<p>MealCoreAI's Hindu Vrat track generates a complete 7-day sattvik meal plan, breakfast, lunch, snack, and dinner, using only vrat-approved ingredients. The plan ensures nutritional completeness while respecting all fasting restrictions. <a href="https://mealcoreai.com/app/sign-up">Start your free vrat meal plan today</a>.</p>
    `.trim()},{slug:"type2-diabetes-reversal-indian-diet",title:"Can Type 2 Diabetes Be Reversed With an Indian Diet? Evidence-Based Guide (2025)",metaTitle:"Type 2 Diabetes Reversal Indian Diet: Is It Possible? | MealCoreAI",metaDescription:"Can type 2 diabetes be reversed with diet in India? A science-based answer with clinical evidence, Indian food examples, a 7-day reversal meal plan, and the role of low-GI Indian foods.",category:"diabetes",tags:["diabetes","reversal","low-gi","indian-diet","blood-sugar","hba1c"],excerpt:"Type 2 diabetes can be put into remission through dietary changes, and Indian cuisine offers powerful natural tools for blood sugar control. This guide explains the clinical evidence and a practical Indian diet reversal plan.",author:"Dr. Suresh Menon, Endocrinology Nutrition Specialist",publishDate:"2025-03-22",dateModified:"2026-05-02",readTimeMin:9,featuredImage:"/images/diabetes-reversal.jpg",keyTakeaways:["46% of type 2 diabetes patients achieved remission in the DiRECT trial after one year of structured dietary intervention (The Lancet, 2018).","A low-GI Indian diet reduced HbA1c by 1.4 percentage points in 12 weeks in an AIIMS New Delhi study — equivalent to a standard oral diabetes medication.","Diabetes remission means HbA1c below 6.5% without medication for 3+ months; reverting to old eating patterns causes blood glucose to rise again.","Losing 10–15% of body weight by reducing visceral fat restores near-normal beta-cell function in most patients who have had diabetes for under 10 years.","Traditional Indian ingredients — karela, methi, amla, turmeric, and millets — are clinically validated for glycaemic control, making dietary reversal more achievable."],relatedSlugs:["diabetic-indian-breakfast-ideas","low-gi-indian-foods-list","ragi-benefits-diabetes","gestational-diabetes-meal-plan"],internalLinks:[{anchor:"diabetes meal plan India",url:"/diabetes-meal-plan"},{anchor:"low-GI Indian foods list",url:"/blog/low-gi-indian-foods-list"},{anchor:"start a personalised diabetes plan",url:"https://mealcoreai.com/app/sign-up"},{anchor:"ragi for diabetes",url:"/blog/ragi-benefits-diabetes"}],content:`
...
<p>MealCoreAI generates personalised low-GI Indian meal plans specifically designed for type 2 diabetes management and reversal. Every meal uses low-GI foods from your regional cuisine, with automatic grocery lists and daily push reminders. <a href="/diabetes-meal-plan">See the diabetes meal plan</a> or <a href="https://mealcoreai.com/app/sign-up">start your free plan today</a>.</p>
    `.trim()},{slug:"pcos-fertility-diet-india",title:"Indian Diet to Improve Fertility With PCOS: A Science-Based Guide for Women Trying to Conceive",metaTitle:"PCOS Fertility Diet India: Foods That Help You Conceive | MealCoreAI",metaDescription:"Indian foods that improve fertility with PCOS, inositol-rich foods, anti-inflammatory meals, hormone-balancing spices, and a 7-day diet plan for women with PCOS trying to conceive naturally.",category:"pcos",tags:["pcos","fertility","conceive","hormone-balance","inositol","indian-diet"],excerpt:"Women with PCOS trying to conceive can significantly improve ovulation frequency and egg quality through targeted dietary changes. This guide covers the key nutrients, Indian food sources, and a practical 7-day plan.",author:"Dr. Priya Sharma, Nutritionist",publishDate:"2025-02-18",dateModified:"2026-05-02",readTimeMin:8,featuredImage:"/images/pcos-fertility.jpg",keyTakeaways:["PCOS is the leading cause of anovulatory infertility in Indian women, affecting approximately 1 in 5 women of reproductive age.","Inositol-rich foods (buckwheat, beans, citrus) improve ovulation frequency in PCOS — multiple randomised controlled trials support this finding.","Reducing insulin resistance through low-GI eating is the most powerful dietary lever for restoring regular ovulation in PCOS.","Anti-inflammatory spices — turmeric, ginger, cinnamon — reduce ovarian inflammation that suppresses ovulation when used consistently.","A PCOS fertility diet shows measurable improvement in ovulation frequency within 3 months of consistent adherence."],relatedSlugs:["pcos-diet-plan-india","pcos-insulin-resistance-diet","pcos-breakfast-ideas-indian","millet-benefits-pcos"],internalLinks:[{anchor:"PCOS meal plan",url:"/pcos-meal-plan"},{anchor:"PCOS diet guide",url:"/blog/pcos-diet-plan-india"},{anchor:"personalised PCOS plan",url:"https://mealcoreai.com/app/sign-up"}],content:`
...
<h3>5. Vitamin D</h3>
<p>Vitamin D deficiency affects 70–90% of Indian women and significantly worsens PCOS symptoms. Research shows Vitamin D supplementation improves menstrual regularity in Vitamin D-deficient PCOS patients. Dietary sources are limited, eggs (2\xb5g/egg), fatty fish, and fortified dairy. Discuss supplementation with your doctor.</p>
...
<p>MealCoreAI's PCOS track generates personalised meal plans that maximise fertility-supportive nutrients, inositol, omega-3, magnesium, and antioxidants, using Indian foods you actually cook and eat. <a href="/pcos-meal-plan">See the PCOS meal plan</a> or <a href="https://mealcoreai.com/app/sign-up">start your free plan today</a>.</p>
    `.trim()},{slug:"maharashtrian-diet-plan-health",title:"Maharashtrian Diet Plan for Weight Loss, Diabetes, and PCOS (Complete 2025 Guide)",metaTitle:"Maharashtrian Diet Plan for Weight Loss & Diabetes | MealCoreAI",metaDescription:"A complete Maharashtrian diet plan for weight loss, diabetes, and PCOS, featuring jowar bhakri, amti, misal, zunka, and other healthy traditional Marathi foods with a 7-day sample plan.",category:"nutrition",tags:["maharashtrian","marathi-diet","jowar","weight-loss","regional-cuisine","bhakri"],excerpt:"Maharashtrian cuisine is one of India's most nutritionally complete, centred on jowar and bajra bhakri, fibre-rich legumes, and vegetable-forward preparations. This guide shows how to harness traditional Marathi food for specific health goals.",author:"Nutritionist Kavita Rao, RD",publishDate:"2025-03-05",dateModified:"2026-05-02",readTimeMin:7,featuredImage:"/images/maharashtrian-diet.jpg",keyTakeaways:["Maharashtrian cuisine is built on jowar and bajra bhakri — both low-GI grains ideal for blood sugar control in diabetes and PCOS.","Traditional amti and usals provide daily legume protein that directly supports hormone balance and metabolic health.","Jowar bhakri has a glycaemic index of approximately 55 vs wheat roti at 70 — a meaningful everyday difference for blood sugar management.","Maharashtrian cooking uses minimal oil and emphasises dry sabzis and legume-based preparations over deep-fried items.","The traditional thali format naturally achieves balanced macros: grain + dal + vegetable + fermented dairy — no calorie counting required."],relatedSlugs:["south-indian-diet-weight-loss","millet-benefits-pcos","low-gi-indian-foods-list"],internalLinks:[{anchor:"personalised meal plan",url:"https://mealcoreai.com/app/sign-up"},{anchor:"millet benefits",url:"/blog/millet-benefits-pcos"},{anchor:"how MealCoreAI works",url:"/how-it-works"}],content:`
...
<ul>
  <li><strong>Jowar bhakri provides 2.7g of fibre per roti</strong> compared to 0.8g for a standard wheat roti of similar size, making it 3.4\xd7 more fibre-dense.</li>
...
<p>MealCoreAI's Maharashtra regional setting generates personalised weekly plans using authentic Maharashtrian dishes, jowar bhakri, amti, matki usal, misal, and shrikhand, calibrated to your health track (diabetes, PCOS, fitness, or general). <a href="https://mealcoreai.com/app/sign-up">Start your free plan today</a>.</p>
    `.trim()},{slug:"complete-guide-indian-diet-health-conditions",title:"Complete Guide to Indian Diet for Health Conditions: PCOS, Diabetes, Thyroid, Pregnancy, and More (2025)",metaTitle:"Indian Diet for PCOS, Diabetes & Thyroid: Health Guide | MealCoreAI",metaDescription:"The authoritative guide to Indian dietary recommendations for major health conditions. PCOS, type 2 diabetes, hypothyroidism, pregnancy, high cholesterol, and vrat fasting. With evidence, comparisons, and free meal plans.",category:"nutrition",tags:["pcos","diabetes","thyroid","pregnancy","cholesterol","indian-diet","health-conditions"],excerpt:"A single authoritative reference covering Indian dietary recommendations for PCOS, diabetes, thyroid, pregnancy, kids nutrition, cholesterol, and vrat fasting, with clinical evidence, comparison tables, and links to specific plans.",author:"MealCoreAI Nutrition Team",publishDate:"2025-04-01",dateModified:"2026-05-02",readTimeMin:12,featuredImage:"/images/complete-guide.jpg",keyTakeaways:["Every major Indian health condition — PCOS, diabetes, thyroid, pregnancy, cholesterol, and child nutrition — has specific dietary requirements covered in this guide.","Low-GI eating (ragi, jowar, bajra instead of white rice) is the single dietary change that benefits all six conditions simultaneously.","Each condition has 2–3 priority nutrients: PCOS needs inositol and zinc; diabetes needs fibre and chromium; thyroid needs selenium and iodine.","Traditional Indian ingredients — karela, methi, amla, turmeric — are clinically evidence-backed for specific conditions, not just general wellness.","Personalised meal planning by condition, region, and food preference consistently outperforms generic diet charts for all conditions in this guide."],relatedSlugs:["pcos-diet-plan-india","type2-diabetes-reversal-indian-diet","thyroid-foods-avoid-india","pregnancy-nutrition-first-trimester","cholesterol-lowering-indian-foods"],internalLinks:[{anchor:"PCOS meal plan",url:"/pcos-meal-plan"},{anchor:"diabetes meal plan",url:"/diabetes-meal-plan"},{anchor:"thyroid diet plan",url:"/thyroid-diet-plan"},{anchor:"pregnancy meal plan",url:"/pregnancy-meal-plan"},{anchor:"cholesterol diet plan",url:"/cholesterol-diet-plan"},{anchor:"kids meal plan",url:"/kids-meal-plan"},{anchor:"vrat diet plan",url:"/blog/vrat-diet-plan-india"},{anchor:"start a personalised plan",url:"https://mealcoreai.com/app/sign-up"}],content:`
...
<p>Hypothyroidism affects approximately 42 million Indians, with women 5–10\xd7 more likely to be affected than men (Thyroid Foundation of India, 2021). The thyroid diet focuses on selenium (for T4→T3 hormone conversion), iodine (for thyroid hormone synthesis), and zinc (for thyroid receptor sensitivity), while avoiding excess raw goitrogenic foods.</p>
<p><strong>Best Indian foods for thyroid:</strong> Selenium. Brazil nuts (544\xb5g/nut), fish, eggs. Iodine, iodised salt, seaweed, fish. Zinc, pumpkin seeds, whole grains, legumes. Cooking cruciferous vegetables (broccoli, cauliflower, cabbage) deactivates 30–90% of goitrogenic compounds, these vegetables do not need to be avoided when cooked.</p>
...
<p><strong>First trimester priority:</strong> Folate (400–600\xb5g/day), from palak, methi, moong sprouts, and lemon. B6 for nausea, from banana, chicken, potatoes, and sunflower seeds. Avoid high-mercury fish (king mackerel, swordfish) and raw papaya.</p>
...
<p>MealCoreAI generates personalised 7-day Indian meal plans for all the conditions covered in this guide, free to start. Select your health condition, regional cuisine, and food preferences, and receive a complete plan in under 2 minutes. <a href="https://mealcoreai.com/app/sign-up">Get your free plan today</a>.</p>
    `.trim()},{slug:"ragi-vs-oats-pcos-diabetes",title:"Ragi vs Oats for PCOS and Diabetes: Which Should You Eat?",metaTitle:"Ragi vs Oats for PCOS and Diabetes: Which Is Better? | MealCoreAI",metaDescription:"Ragi vs oats for PCOS and diabetes — a direct comparison of glycaemic index, fibre, minerals, and hormonal effects for Indian women. Which grain should you choose?",category:"pcos",tags:["ragi","oats","PCOS","diabetes","low-GI","millets","Indian diet"],excerpt:"Ragi and oats are both promoted for PCOS and diabetes management. But they have meaningfully different nutritional profiles. Here is a direct comparison to help you choose.",author:"Dr. Priya Sharma",publishDate:"2026-04-28",dateModified:"2026-05-02",readTimeMin:9,featuredImage:"/images/blog/ragi-vs-oats.jpg",keyTakeaways:["Ragi (GI: 54) and oats (GI: 55) have nearly identical glycaemic indexes — the difference lies in their specific micronutrient profiles.","Ragi has 344mg of calcium per 100g vs oats at 54mg — a critical advantage for Indian women with PCOS who are frequently calcium-deficient.","Oats contain beta-glucan fibre with the strongest clinical evidence for LDL reduction — ragi does not provide this specific benefit.","For PCOS and diabetes: ragi's calcium and chromium content give it an edge for insulin sensitivity and hormonal support.","The optimal strategy is rotation: ragi as the primary grain for most meals, oats for breakfast two to three times per week."],relatedSlugs:["millet-benefits-pcos","ragi-benefits-diabetes","low-gi-indian-foods-list"],internalLinks:[{anchor:"PCOS meal plan for Indian women",url:"/pcos-meal-plan"},{anchor:"diabetes meal plan India",url:"/diabetes-meal-plan"}],content:`
...
<p>Get a <a href="https://mealcoreai.com/pcos-meal-plan">personalised PCOS meal plan</a> that incorporates ragi and oats in the right quantities for your specific calorie needs, or explore the <a href="https://mealcoreai.com/diabetes-meal-plan">diabetes meal plan for Indians</a> with millet-forward meal structures.</p>
    `.trim()},{slug:"pcos-thyroid-combined-diet-india",title:"PCOS and Thyroid Together: What to Eat When You Have Both",metaTitle:"PCOS & Thyroid Combined Diet for Indian Women | MealCoreAI",metaDescription:"Up to 30% of women with PCOS also have thyroid dysfunction. Here is the combined diet approach for Indian women managing both conditions simultaneously.",category:"pcos",tags:["PCOS","thyroid","hypothyroidism","combined diet","Indian women","hormonal health"],excerpt:"Up to 30% of Indian women with PCOS also have thyroid dysfunction. The dietary approaches overlap significantly — but there are specific conflicts to navigate and foods that address both conditions at once.",author:"Dr. Priya Sharma",publishDate:"2026-04-29",dateModified:"2026-04-29",readTimeMin:11,featuredImage:"/images/blog/pcos-thyroid-diet.jpg",relatedSlugs:["pcos-diet-plan-india","thyroid-foods-avoid-india","millet-benefits-pcos"],internalLinks:[{anchor:"PCOS meal plan for Indian women",url:"/pcos-meal-plan"},{anchor:"thyroid diet plan India",url:"/thyroid-diet-plan"}],content:`
...
<p>Managing both conditions with Indian food is achievable. Explore the <a href="https://mealcoreai.com/pcos-meal-plan">PCOS meal plan</a> and <a href="https://mealcoreai.com/thyroid-diet-plan">thyroid diet plan</a> to understand each condition's approach, or get a <a href="https://mealcoreai.com/app/sign-up">personalised plan</a> that accounts for both simultaneously.</p>
    `.trim()},{slug:"low-gi-vs-high-gi-indian-foods-diabetes",title:"Low-GI vs High-GI Indian Foods: A Complete Comparison for Diabetics",metaTitle:"Low-GI vs High-GI Indian Foods for Diabetes | MealCoreAI",metaDescription:"Complete comparison of low-GI and high-GI Indian foods for diabetes management. Includes GI values for common Indian grains, fruits, vegetables, and snacks with practical swaps.",category:"diabetes",tags:["low-GI","high-GI","diabetes","glycaemic index","Indian foods","blood sugar"],excerpt:"A practical side-by-side comparison of low-GI and high-GI Indian foods with GI values, glycaemic load, and specific swaps that keep blood sugar stable without abandoning Indian cuisine.",author:"Dr. Priya Sharma",publishDate:"2026-04-30",dateModified:"2026-04-30",readTimeMin:12,featuredImage:"/images/blog/low-gi-vs-high-gi.jpg",relatedSlugs:["low-gi-indian-foods-list","diabetic-indian-breakfast-ideas","ragi-benefits-diabetes"],internalLinks:[{anchor:"diabetes meal plan for Indians",url:"/diabetes-meal-plan"},{anchor:"low-GI Indian foods list",url:"/blog/low-gi-indian-foods-list"}],content:`
...
<p>Explore the complete <a href="https://mealcoreai.com/diabetes-meal-plan">diabetes meal plan for Indians</a> or get a <a href="https://mealcoreai.com/app/sign-up">personalised plan</a> that automatically applies low-GI principles to your regional Indian cuisine preferences.</p>
    `.trim()},{slug:"mealcoreai-vs-generic-diet-chart",title:"AI Meal Plan vs Generic Diet Chart: Why One-Size-Fits-All Fails Indian Women",metaTitle:"AI Meal Plan vs Generic Diet Chart for Indian Women | MealCoreAI",metaDescription:"Generic diet charts give the same plan to everyone. AI meal planning personalises every meal by condition, region, season, and preference. Here is what the difference looks like in practice.",category:"general",tags:["AI meal plan","personalised nutrition","diet chart","Indian women","PCOS","diabetes"],excerpt:"Generic diet charts for PCOS and diabetes circulate on WhatsApp and doctor's clinic walls. They are better than nothing. But here is exactly what personalised AI meal planning does differently — and why it matters for Indian women.",author:"Dr. Priya Sharma",publishDate:"2026-05-01",dateModified:"2026-05-02",readTimeMin:8,featuredImage:"/images/blog/ai-vs-generic-diet.jpg",keyTakeaways:["Generic diet charts give every person the same 1,200-calorie plan — AI meal planning adjusts to your condition, severity, region, and preferences.","A generic chart cannot account for regional Indian food differences: South Indian, North Indian, and Gujarati diets are culturally and nutritionally distinct.","AI cross-references GI, micronutrient targets, seasonal produce, cultural fasting days, and cooking constraints in a single plan.","Higher adherence with AI plans comes from a simple reason: the meals are foods users actually cook and already enjoy.","AI generates a new personalised plan every week — a printed diet chart is nutritionally stale after the first month."],relatedSlugs:["ai-meal-planning-personalised-nutrition","meal-planning-beginners-india","pcos-diet-plan-india"],internalLinks:[{anchor:"personalised PCOS meal plan",url:"/pcos-meal-plan"},{anchor:"AI-personalised Indian meal planning",url:"/blog/ai-meal-planning-personalised-nutrition"}],content:`
...
<p>MealCoreAI generates personalised 7-day Indian meal plans based on your health condition, region, food preferences, cook time, and calorie goals. Free to start. <a href="https://mealcoreai.com/app/sign-up">Get your personalised plan in 90 seconds</a> — or explore condition-specific approaches for <a href="https://mealcoreai.com/pcos-meal-plan">PCOS</a>, <a href="https://mealcoreai.com/diabetes-meal-plan">diabetes</a>, <a href="https://mealcoreai.com/thyroid-diet-plan">thyroid</a>, and other conditions.</p>
    `.trim()}],u="https://mealcoreai.com";function p(){let e=[{url:u,lastModified:new Date("2026-04-22"),changeFrequency:"daily",priority:1},{url:`${u}/how-it-works`,lastModified:new Date("2026-04-10"),changeFrequency:"monthly",priority:.8},{url:`${u}/pricing`,lastModified:new Date("2026-04-15"),changeFrequency:"monthly",priority:.8},{url:`${u}/blog`,lastModified:new Date("2026-04-22"),changeFrequency:"weekly",priority:.8},{url:`${u}/faq`,lastModified:new Date("2026-04-10"),changeFrequency:"monthly",priority:.7},{url:`${u}/about`,lastModified:new Date("2026-04-10"),changeFrequency:"monthly",priority:.6}],a=[{url:`${u}/pcos-meal-plan`,lastModified:new Date("2026-05-02"),changeFrequency:"weekly",priority:.9},{url:`${u}/diabetes-meal-plan`,lastModified:new Date("2026-05-02"),changeFrequency:"weekly",priority:.9},{url:`${u}/thyroid-diet-plan`,lastModified:new Date("2026-05-02"),changeFrequency:"weekly",priority:.9},{url:`${u}/pregnancy-meal-plan`,lastModified:new Date("2026-05-02"),changeFrequency:"weekly",priority:.9},{url:`${u}/kids-meal-plan`,lastModified:new Date("2026-05-02"),changeFrequency:"weekly",priority:.9},{url:`${u}/cholesterol-diet-plan`,lastModified:new Date("2026-05-02"),changeFrequency:"weekly",priority:.9},{url:`${u}/weight-loss-meal-plan`,lastModified:new Date("2026-05-03"),changeFrequency:"weekly",priority:.9}],i=["pcos-weekly-meal-plan-south-indian","pcos-weekly-meal-plan-bengali","pcos-weekly-meal-plan-punjabi","pcos-weekly-meal-plan-maharashtrian","diabetes-7-day-meal-plan-south-indian","diabetes-7-day-meal-plan-punjabi","diabetes-7-day-meal-plan-bengali","thyroid-diet-plan-south-indian","thyroid-diet-plan-north-indian","weight-loss-meal-plan-south-indian","weight-loss-meal-plan-north-indian","pregnancy-meal-plan-south-indian","pregnancy-meal-plan-north-indian","kids-meal-plan-south-indian","kids-meal-plan-north-indian","cholesterol-weekly-meal-plan-south-indian","cholesterol-weekly-meal-plan-north-indian","cholesterol-weekly-meal-plan-gujarati","thyroid-weekly-meal-plan-south-indian","thyroid-weekly-meal-plan-north-indian","thyroid-weekly-meal-plan-gujarati","kids-weekly-meal-plan-south-indian","kids-weekly-meal-plan-north-indian","kids-weekly-meal-plan-gujarati","kids-lunch-ideas-north-indian","pregnancy-weekly-meal-plan-south-indian","pregnancy-weekly-meal-plan-north-indian","pregnancy-weekly-meal-plan-gujarati","pregnancy-7-day-meal-plan-north-indian"],t=new Set(i),n=[...i];for(let e of d){for(let a of c){for(let i of h){var o,r,s;if(n.length>=265)break;let l=(o=e.id,r=a.id,s=i.id,`${o}-${r}-${s}`);t.has(l)||(t.add(l),n.push(l))}if(n.length>=265)break}if(n.length>=265)break}let l=new Date("2026-04-22");return[...e,...a,...n.map(e=>({url:`${u}/meal-plans/${e}`,lastModified:l,changeFrequency:"weekly",priority:.7})),...g.map(e=>({url:`${u}/blog/${e.slug}`,lastModified:new Date(e.publishDate),changeFrequency:"monthly",priority:.6}))]}var m=i(6068);let f={...t},y=f.default,b=f.generateSitemaps;if("function"!=typeof y)throw Error('Default export is missing in "/home/runner/workspace/artifacts/marketing/app/sitemap.ts"');async function w(e,a){let i;let{__metadata_id__:t,...n}=a.params||{},o=b?await b():null;if(o&&null==(i=o.find(e=>{let a=e.id.toString();return(a+=".xml")===t})?.id))return new l.NextResponse("Not Found",{status:404});let r=await y({id:i}),s=(0,m.resolveRouteData)(r,"sitemap");return new l.NextResponse(s,{headers:{"Content-Type":"application/xml","Cache-Control":"public, max-age=0, must-revalidate"}})}let k=new o.AppRouteRouteModule({definition:{kind:r.x.APP_ROUTE,page:"/sitemap.xml/route",pathname:"/sitemap.xml",filename:"sitemap",bundlePath:"app/sitemap.xml/route"},resolvedPagePath:"next-metadata-route-loader?page=%2Fsitemap.xml%2Froute&filePath=%2Fhome%2Frunner%2Fworkspace%2Fartifacts%2Fmarketing%2Fapp%2Fsitemap.ts&isDynamic=1!?__next_metadata_route__",nextConfigOutput:"",userland:n}),{requestAsyncStorage:v,staticGenerationAsyncStorage:I,serverHooks:S}=k,C="/sitemap.xml/route";function P(){return(0,s.patchFetch)({serverHooks:S,staticGenerationAsyncStorage:I})}},6068:(e,a,i)=>{Object.defineProperty(a,"__esModule",{value:!0}),function(e,a){for(var i in a)Object.defineProperty(e,i,{enumerable:!0,get:a[i]})}(a,{resolveManifest:function(){return r},resolveRobots:function(){return n},resolveRouteData:function(){return s},resolveSitemap:function(){return o}});let t=i(432);function n(e){let a="";for(let i of Array.isArray(e.rules)?e.rules:[e.rules]){for(let e of(0,t.resolveArray)(i.userAgent||["*"]))a+=`User-Agent: ${e}
`;if(i.allow)for(let e of(0,t.resolveArray)(i.allow))a+=`Allow: ${e}
`;if(i.disallow)for(let e of(0,t.resolveArray)(i.disallow))a+=`Disallow: ${e}
`;i.crawlDelay&&(a+=`Crawl-delay: ${i.crawlDelay}
`),a+="\n"}return e.host&&(a+=`Host: ${e.host}
`),e.sitemap&&(0,t.resolveArray)(e.sitemap).forEach(e=>{a+=`Sitemap: ${e}
`}),a}function o(e){let a=e.some(e=>Object.keys(e.alternates??{}).length>0),i="";for(let n of(i+='<?xml version="1.0" encoding="UTF-8"?>\n<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"',a?i+=' xmlns:xhtml="http://www.w3.org/1999/xhtml">\n':i+=">\n",e)){var t;i+=`<url>
<loc>${n.url}</loc>
`;let e=null==(t=n.alternates)?void 0:t.languages;if(e&&Object.keys(e).length)for(let a in e)i+=`<xhtml:link rel="alternate" hreflang="${a}" href="${e[a]}" />
`;if(n.lastModified){let e=n.lastModified instanceof Date?n.lastModified.toISOString():n.lastModified;i+=`<lastmod>${e}</lastmod>
`}n.changeFrequency&&(i+=`<changefreq>${n.changeFrequency}</changefreq>
`),"number"==typeof n.priority&&(i+=`<priority>${n.priority}</priority>
`),i+="</url>\n"}return i+"</urlset>\n"}function r(e){return JSON.stringify(e)}function s(e,a){return"robots"===a?n(e):"sitemap"===a?o(e):"manifest"===a?r(e):""}},432:(e,a)=>{function i(e){return Array.isArray(e)?e:[e]}function t(e){if(null!=e)return i(e)}Object.defineProperty(a,"__esModule",{value:!0}),function(e,a){for(var i in a)Object.defineProperty(e,i,{enumerable:!0,get:a[i]})}(a,{resolveArray:function(){return i},resolveAsArrayOrUndefined:function(){return t}})}};var a=require("../../webpack-runtime.js");a.C(e);var i=e=>a(a.s=e),t=a.X(0,[147,766],()=>i(1955));module.exports=t})();